...
namespace ATSAudit.Controllers.Api
{
    ...
    public class CorrectiveActionsController : ControllerBase
    {
        ...
        private readonly ICorrectiveActionsRepository _repository;
        // private readonly dynamic _session;

        public CorrectiveActionsController(ICorrectiveActionsRepository repository)
        {
       ...
       public async Task<IEnumerable<CorrectiveActionModel>> GetCorrectiveAction(int correctiveActionId) 
       {
        ...
        public async Task<int> PostCorrectiveAction([FromForm] CorrectiveActionModel request)
        {
