...
namespace QA_Audit_Fresh.Repositories
{
    public interface IPreventiveActionRepository
    {
        ...
        public Task<IEnumerable<PreventiveActionModel>> GetPreventiveAction(int conformityNo);
        public Task<IEnumerable<PreventiveActionModel>> GetPreventiveActionsByCPAR(int planId);
